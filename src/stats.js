    ...
    stats.forEach((report) => {
     ...
     if (remoteInboundRtp.roundTripTime > 0) {
        ...
        if (remoteInboundRtp.fractionLost >= 0 && remoteInboundRtp.jitter >= 0) {
            remoteInboundRtp.mos = calcMos(remoteInboundRtp.roundTripTime, remoteInboundRtp.jitter, remoteInboundRtp.fractionLost*100);
        }
        if (localInboundRtp.fractionLost >= 0 && localInboundRtp.jitter >= 0) {
            localInboundRtp.mos = calcMos(remoteInboundRtp.roundTripTime, localInboundRtp.jitter, localInboundRtp.fractionLost*100);
        }
        ...
        if (remoteInboundRtp.mosInterval == -1) {
            ...
            remoteInboundRtp.mosInterval = calcMos(remoteInboundRtp.roundTripTime, remoteInboundRtp.jitter, fractionLost);
        }
        ...
        if (localInboundRtp.mosInterval == -1) {
            ...
            localInboundRtp.mosInterval = calcMos(remoteInboundRtp.roundTripTime, localInboundRtp.jitter, fractionLost);
