...
COPY --chown=pptruser:pptruser ./docker-puppeteer/tools /tools


# INSTALL AND BUILD TEST LIBRARY
COPY . /getstats-sip.js
COPY ./dist /getstats-sip.js/dist
RUN cd /getstats-sip.js \
	&& npm init -y \
